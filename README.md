...
Tech Stack: A lot of the work is done on the back-end, where I am gaining experience developing a real-world application that must function efficiently and securely. Front-end is Blazor WebAssembly, Back-end is ASP.NET API with Oracle database.
# Word Riddle
